...
def build_ai_input(items: List[Dict], fred_items: List[Dict], akshare_text: str, polymarket_markets: List[Dict] = None, active_theses: List[Dict] = None, calibration_stats: Dict = None) -> str:
    # 按类别分组
    cats = {}
    for item in items:
...
def main():
    ...
    ai_input = build_ai_input(filtered, fred_items, akshare_text, fetch_polymarket_data(), load_active_theses(), get_calibration_stats())
